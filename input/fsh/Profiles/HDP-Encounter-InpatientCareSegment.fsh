...
* reasonCode ^comment = "A segment-specific reason SHOULD be populated when known in the source system, particularly for significant-event segments. It need not repeat the reason recorded on the parent hospitalization."
* reasonReference ^alias[0] = "סיבת ביקור/סיבה לאשפוז"
* reasonReference ^comment = "References to Conditions to be addressed and/or Procedures to be performed during this segment SHOULD be populated when known in the source system, particularly for significant-event segments. They need not repeat reasons recorded on the parent hospitalization."
